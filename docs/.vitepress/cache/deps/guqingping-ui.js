    ...
    (function(i, e) {
      ...
      const p = "", l = (o, s) => {
        ...
        for (const [a, n] of s)
          t[a] = n;
        return t;
      }, _ = (o) => (e.pushScopeId("data-v-cb511ac3"), o = o(), e.popScopeId(), o), u = { text: "" }, f = _(() => e.createElementVNode("div", { cover: "" }, null, -1)), c = l(Object.assign({ name: "gqp_notification" }, { setup(o, { expose: s }) {
