...
const k = (i, c) => {
  ...
  for (const [d, e] of c)
    s[d] = e;
  return s;
}, B = (i) => (y("data-v-7eedd885"), i = i(), w(), i), E = { list: "" }, V = ["onClick", "data-index"], z = /* @__PURE__ */ B(() => /* @__PURE__ */ n("div", { cover: "" }, null, -1)), L = { name: "gqp_notification" }, D = /* @__PURE__ */ Object.assign(L, {
  props: {
    //带类型和默认值的写法
    type: {
      type: Number,
  ...
  setup(i, { expose: c }) {
    ...
    let e = s.value, h = function(t = $(e.default_config)) {
...
}), u = /* @__PURE__ */ k(D, [["__scopeId", "data-v-7eedd885"]]);
